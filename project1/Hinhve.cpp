...
void HinhVe::RenderRectangle(const HinhVeFormat& geo_size, const ColorData& color_data, SDL_Renderer* screen)
{
...
void HinhVe::RenderOutline(const HinhVeFormat& geo_size, const ColorData& color_data, SDL_Renderer* screen)
{
